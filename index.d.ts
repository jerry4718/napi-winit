...
export declare namespace Extra {
  ...
  export function asyncSleep(millis: number): Promise<unknown>
  ...
  export function threadInterval(timeout: Timeout, exec: () => (Promise<void> | void)): void
  export function tokioCallSpawn(callback: () => (Promise<void> | void)): void
  export function tokioInterval(timeout: Timeout, exec: () => (Promise<void> | void)): void
  export function tokioSleep(timeout: Timeout): Promise<void>
}

export declare namespace Timeout {
  export function fromMicros(micros: number): Timeout
  export function fromMillis(millis: number): Timeout
...
export type ControlFlow =
  | { type: 'Poll' }
  | { type: 'Wait' }
  | { type: 'WaitUntil', timeout: Timeout }
...
export type StartCause =
  | { type: 'ResumeTimeReached', start: Timeout, requestedResume: Timeout }
  | { type: 'WaitCancelled', start: Timeout, requestedResume?: Timeout }
  | { type: 'Poll' }
  | { type: 'Init' }
