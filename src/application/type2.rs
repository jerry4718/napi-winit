...
impl ApplicationT2 {
    #[napi(constructor)]
    pub fn new(env: Env, callbacks: ApplicationOptions) -> Self {
        Self {
            env,
    ...
    #[napi(factory)]
    pub fn from_refs(env: Env, callbacks: ApplicationOptionRefs) -> Self {
        Self {
            env,
...
impl ApplicationHandler<UserPayload> for ApplicationT2 {
