...
pub struct ApplicationOptions<'scope> {
    #[napi(ts_type = "(eventLoop: ActiveEventLoop, cause: StartCause) => Promise<void>")]
    pub on_new_events: Option<Function<'scope, FnArgs<(ActiveEventLoop, StartCause)>, Option<Promise<()>>>>,
    #[napi(ts_type = "(eventLoop: ActiveEventLoop) => Promise<void>")]
    pub on_resumed: Function<'scope, FnArgs<(ActiveEventLoop,)>, Option<Promise<()>>>,
    #[napi(ts_type = "(eventLoop: ActiveEventLoop, event: UserPayload) => Promise<void>")]
    pub on_user_event: Option<Function<'scope, FnArgs<(ActiveEventLoop, UserPayload)>, Option<Promise<()>>>>,
    #[napi(ts_type = "(eventLoop: ActiveEventLoop, windowId: WindowId, event: WindowEvent) => Promise<void>")]
    pub on_window_event: Function<'scope, FnArgs<(ActiveEventLoop, WindowId, WindowEvent)>, Option<Promise<()>>>,
    #[napi(ts_type = "(eventLoop: ActiveEventLoop, deviceId: DeviceId, event: DeviceEvent) => Promise<void>")]
...
#[napi(object, object_to_js = false)]
pub struct ApplicationSyncOptions<'scope> {
...
#[napi(object, object_to_js = false)]
pub struct ApplicationSyncOptionRefs {
    #[napi(ts_type = "(eventLoop: ActiveEventLoop, cause: StartCause) => void")]
