use crate::{
    ...
    utils::{
        append_to_tokens, define_const_str, get_type_ty_or, map_meta_to_local, parse_metas,
        separate_attr_by_name,
    },
};
use proc_macro2::{Ident, TokenStream};
use quote::{ToTokens, format_ident, quote};
use syn::{Attribute, ItemStruct, Meta, Type, parse_macro_input};

pub(crate) fn proxy_struct(
...
define_const_str!(META_OBJECT = object, META_ORIGIN_TYPE = origin_type,);
